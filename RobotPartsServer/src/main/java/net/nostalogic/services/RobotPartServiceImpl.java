...
import net.nostalogic.schema.dto.RobotPartDto;
import net.nostalogic.schema.repositories.CompatibilityRepository;
import net.nostalogic.schema.repositories.ManufacturerRepository;
import net.nostalogic.schema.repositories.RobotPartRepository;
